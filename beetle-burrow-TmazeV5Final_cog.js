...
const demo_trial_eaten = {
    ...
    demo_text: 'Example: The beetle was eaten by the predator.\nTone ended during predator encounter!',
    trial_number: 'Demo 1',
    phase: 0
};
...
const demo_trial_escaped = {
    ...
    demo_text: 'Example: The beetle escaped through the exit.\nTone continues after the predator encounter!',
    trial_number: 'Demo 2',
    phase: 0
};
...
const demo_loop = {
    timeline: [
        {
            type: jsPsychHtmlButtonResponse,
            stimulus: '<h2 style="font-family:Georgia, serif;color:#5d4037">Let\'s watch a quick demo.</h2><p>You will see two example trials. You do not need to respond.  Pay attention to the audio and the correct outcome.</p>',
            choices: ['Start Demo']
        },
        demo_trial_eaten,
        demo_trial_escaped,
