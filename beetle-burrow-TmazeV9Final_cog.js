        ...
        trial(display_element, trial) {
            ...
            function drawFeedback() {
                ...
                if (trial.is_demo) {
                    ...
                    const startY = mazeY - 60 - (lines.length - 1) * lineHeight / 2;
                ...
                if (!bug.isFading) {
                    if (bug.direction === null) {
                        if (bug.y < junctionY + topHeight / 2) {
                            ...
                            if (trial.is_demo) {
                                if (trial.demo_outcome === 'stop-vertical') {
                                    bug.visible = false; 
                                    endTrial();         
                                    return;              
                                }
                        ...
                        } else if (bug.actualOutcome.startsWith('stop-horizontal')) {
                            const stopX = bug.direction === 'left' 
                                ? leftPocketCenterX - pocketRadius - 20 
                                : rightPocketCenterX + pocketRadius + 20;
    ...
    pages: [
        `<div style="background:#f5e6d3;padding:50px;border-radius:20px;max-width:800px;margin:auto">
            ...
            <ul style="text-align:left">
                <li>A beetle is burrowing through a tree.</li>
                ...
                <li>For example, if one of the 3 predators has a high preference for the beetle, it is highly likely the beetle will be eaten if it encounters that predator.</li>
                <li>Click where you think the beetle ended up: either eaten by one of the predators or escaped through one of the exits.</li>
    ...
    timeline: [
        {
            ...
            demo_outcome: 'stop-vertical', 
            demo_text: "A beetle is burrowing through the tree\nIt makes an audible noise as it moves.",
            demo_visible_bug: true, 
            trial_number: 'Instruction',
            phase: 0
        },
        {
            type: TMazePlugin,
            ...
            demo_outcome: 'stop-horizontal-right', 
            demo_text: "The beetle speeds up when it is near a predator\nand thus the noise increases in frequency.",
            demo_visible_bug: true, 
            trial_number: 'Instruction',
            phase: 0
        },
        {
            type: jsPsychHtmlButtonResponse,
            stimulus: `
                <div style="width: 500px; border:4px solid #6d4c41; border-radius:15px; background:#f5e6d3; font-family: Georgia, serif; color: #3e2723; text-align: center; padding: 40px 20px;">
                    
                    <div>
                        <p style="font-size: 20px; font-weight: bold; margin: 0;">The tree has nests where 1 of 3 predators are hiding.</p>
                        <p style="font-size: 20px; font-weight: bold; margin-top: 5px;">The predators have specific, unique preferences for each different beetle.</p>
                    </div>
                    ...
                    <div style="display: flex; flex-direction: column; align-items: center; gap: 30px; margin-top: 40px;">
                        <div style="display: flex; align-items: center; justify-content: center; gap: 50px;">
                            <img src="red_bug.png" style="height: 80px;" title="Red-Orange Beetle">
                            <img src="blue_bug.png" style="height: 80px;" title="Blue Beetle">
                        </div>
                        <div style="display: flex; align-items: center; justify-content: center; gap: 40px;">
                            <img src="Pink.png" style="height: 70px;" title="Pink Predator">
                            <img src="Orange.png" style="height: 70px;" title="Orange Predator">
                            <img src="Yellow.png" style="height: 70px;" title="Yellow Predator">
                        </div>
                    </div>
        ...
        },
        {
            ...
            demo_text: "The beetle will either be eaten\n or escape depending on the predators\n it comes across on its path to the exit.",
            demo_visible_bug: true,
            trial_number: 'Instruction',
            phase: 0
        },
        {
            ...
            demo_text: "If one of the predators has a high preference\n for the beetle, it is highly likely the beetle\n will be eaten if it encounters that predator.",
            demo_visible_bug: true,
            trial_number: 'Instruction',
            phase: 0
        },
        {
            ...
            stimulus: `
                <div style="width: 500px; height: 500px; border:4px solid #6d4c41; border-radius:15px; background:#f5e6d3; position: relative; font-family: Georgia, serif; color: #3e2723; text-align: center; overflow: hidden;">

                    <!-- Instruction Text -->
                    <p style="font-size: 20px; font-weight: bold; margin-top: 60px;">Click where you think the beetle ended up: either eaten by one of the predators or escaped through one of the exits.</p>

                    <!-- Maze Structure -->
                    <div style="position: absolute; background-color: #4a3426; width: 40px; height: 100px; top: 180px; left: 230px;"></div>
                    <div style="position: absolute; background-color: #4a3426; width: 360px; height: 40px; top: 280px; left: 70px;"></div>

                    <!-- Predator Pockets & Predators -->
                    <div style="position: absolute; width: 70px; height: 35px; background-color: rgba(205, 133, 63, 0.4); border: 2px solid rgba(139, 90, 43, 0.5); top: 320px; left: 150px; border-top: none; border-radius: 0 0 35px 35px;">
                        <img src="Pink.png" style="height: 33px; position: absolute; bottom: 2px; left: 50%; transform: translateX(-50%);">
                    </div>
                    <div style="position: absolute; width: 70px; height: 35px; background-color: rgba(205, 133, 63, 0.4); border: 2px solid rgba(139, 90, 43, 0.5); top: 320px; left: 280px; border-top: none; border-radius: 0 0 35px 35px;">
                        <img src="Orange.png" style="height: 33px; position: absolute; bottom: 2px; left: 50%; transform: translateX(-50%);">
                    </div>

                    <!-- Highlighted Choice Zones -->
                    <div style="position: absolute; background-color: rgba(128, 128, 128, 0.35); top: 280px; left: 70px; width: 60px; height: 40px;" title="Escaped Left"></div>
                    <div style="position: absolute; background-color: rgba(128, 128, 128, 0.35); top: 320px; left: 150px; width: 70px; height: 35px; border-radius: 0 0 35px 35px;" title="Eaten Left"></div>
                    <div style="position: absolute; background-color: rgba(128, 128, 128, 0.35); top: 280px; left: 370px; width: 60px; height: 40px;" title="Escaped Right"></div>
                    <div style="position: absolute; background-color: rgba(128, 128, 128, 0.35); top: 320px; left: 280px; width: 70px; height: 35px; border-radius: 0 0 35px 35px;" title="Eaten Right"></div>
            ...
            stimulus: `
                <div style="width: 500px; height: 500px; border:4px solid #6d4c41; border-radius:15px; background:#f5e6d3; position: relative; font-family: Georgia, serif; color: #3e2723; text-align: center; overflow: hidden;">
                    ...
                    <div style="margin-top: 60px;">
                        <p style="font-size: 20px; font-weight: bold; margin: 0;">You'll receive immediate feedback.</p>
                        <p style="font-size: 18px; margin-top: 5px;">(It is recommended to wear headphones!)</p>
                    </div>
                    ...
                    <!-- Predator Pockets -->
                    <div style="position: absolute; width: 70px; height: 35px; background-color: rgba(205, 133, 63, 0.4); border: 2px solid rgba(139, 90, 43, 0.5); top: 320px; left: 150px; border-top: none; border-radius: 0 0 35px 35px;"></div>
                    <div style="position: absolute; width: 70px; height: 35px; background-color: rgba(205, 133, 63, 0.4); border: 2px solid rgba(139, 90, 43, 0.5); top: 320px; left: 280px; border-top: none; border-radius: 0 0 35px 35px;"></div>

                    <!-- Feedback Text -->
                    <p style="position: absolute; top: 135px; left: 50%; transform: translateX(-50%); font-family: serif; font-weight: 700; font-size: 24px; color: #689f38;">Correct!</p>
                    
                    <!-- Green Overlay for Correct Choice -->
                    <div style="position: absolute; background-color: #689f38; opacity: 0.5; top: 320px; left: 280px; width: 70px; height: 35px; border-radius: 0 0 35px 35px;" title="Correct Choice"></div>
                </div>
            `,
            choices: "NO_KEYS",
            trial_duration: 8000
...

        {
            ...
            stimulus: `
                <div style="width: 500px; height: 500px; border:4px solid #6d4c41; border-radius:15px; background:#f5e6d3; position: relative; font-family: Georgia, serif; color: #3e2723; text-align: center; overflow: hidden;">
                    ...
                    <!-- Feedback Text -->
                    <p style="position: absolute; top: 135px; left: 50%; transform: translateX(-50%); font-family: serif; font-weight: 700; font-size: 24px; color: #d84315;">Incorrect!</p>

                    <!-- Red Overlay for Incorrect User Choice -->
                    <div style="position: absolute; background-color: #d84315; opacity: 0.5; top: 280px; left: 370px; width: 60px; height: 40px;" title="Incorrect Choice"></div>

                    <!-- Blue Overlay for Actual Outcome -->
                    <div style="position: absolute; background-color: #3498db; opacity: 0.5; top: 320px; left: 280px; width: 70px; height: 35px; border-radius: 0 0 35px 35px;" title="Actual Outcome"></div>
                </div>
            `,
            choices: "NO_KEYS",
            trial_duration: 8000
...
const phase2_transition = createPhaseTransition("A different bug has entered the tree!  The predators have different preferences for this new beetle.");
const phase2_trials = {
    timeline: [
        {
            type: TMazePlugin,
